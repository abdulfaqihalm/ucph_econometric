...
The sign of $\delta_1$ means that whether the distance to incinerator in 1981 reduced or increased house price. Meanwhile, if $\beta_1>0$ it means whether the distance from incinerator only actually increased the housing price (assuming other factors are constant). 
